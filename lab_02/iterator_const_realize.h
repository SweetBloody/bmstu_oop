#ifndef LAB_02_ITERATOR_CONST_REALIZE_H
#define LAB_02_ITERATOR_CONST_REALIZE_H

#include "iterator_const.h"

template <typename Type>
IteratorConst<Type>& IteratorConst<Type>::operator =(const IteratorConst<Type>& iter)
{
    _data = iter._data;
    _index = iter._index;
...
template <typename Type>
IteratorConst<Type> IteratorConst<Type>::operator ++(int) const
{
...
template <typename Type>
IteratorConst<Type> IteratorConst<Type>::operator +(const int value) const
{
    IteratorConst<Type> iter(*this);
...
template <typename Type>
IteratorConst<Type>& IteratorConst<Type>::operator +=(const size_t value)
{
    _index += value;
    return *this;
}
...
template <typename Type>
void IteratorConst<Type>::check_valid(size_t line)
{
...
template <typename Type>
void IteratorConst<Type>::check_index(size_t line)
{
    time_t err_time = time(nullptr);
...
#endif //LAB_02_ITERATOR_CONST_REALIZE_H
